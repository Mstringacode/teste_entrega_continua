              ...
              <div class="col-md-6 offset-md-3">
                <div class="card-user">
                  ...
                  <div class="card-body">
                    ...
                    <hr>
                    <p class="card-text">Nome: <span class="info-user"><?php echo $nome; ?></span> </p>
                    <hr>
                    <p class="card-text">Email: <span class="info-user"><?php echo $email; ?></span></p>
                    <hr>
                    <p class="card-text">Telefone: <span class="info-user"><?php echo $telefone; ?></span></p>
                    <hr>
                    <a href="usuario-perfil-editar.php" class="btn btn-primary">Editar</a>
                  </div>
                </div>
              </div>
            </div>
