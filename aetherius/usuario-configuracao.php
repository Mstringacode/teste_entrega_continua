    ...
    <main>
        <div class="box-notificacao">
            <div class="container mt-5">
                <h1 class="mb-4">Configuração de Notificação</h1>
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" id="ativarTelegram" name="ativarTelegram">
                    <label class="form-check-label ms-2" for="ativarTelegram">
                        <i class="fab fa-telegram fa-lg"></i> Ativar notificação via Telegram
                    </label>
                </div>
