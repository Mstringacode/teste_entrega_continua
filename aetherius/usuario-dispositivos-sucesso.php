...
<main>
    <div class="box-formulario">
        <div class="container mt-5">
            <h1 class="mb-4">Cadastro de Aetherius</h1>
            <form id="form-dispositivo" action="../aetherius/php/registrar-dispositivos.php" method="post">
                ...
                <div class="mb-3">
                    <label for="nome" class="form-label">Nome da Rua:</label>
                    <input type="text" class="form-control" id="end_rua" name="end_rua" required>
                </div>
                <div class="mb-3">
                    <label for="nome" class="form-label">Número da Residência:</label>
                    <input type="text" class="form-control" id="numero" name="numero" required>
                </div>
                <button type="submit" class="btn btn-primary">Cadastrar</button>
            </form>
            <h3 class="mt-5" >
                <p>Dispositivos registrado com sucesso. E já pode ser consultado no mapa.</p>
            </h3>
        </div>
    </div>
    <script>
